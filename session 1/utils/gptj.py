...
from transformers.models import gptj
...
class GPTJBlock(gptj.modeling_gptj.GPTJBlock):
...
class GPTJModel(gptj.modeling_gptj.GPTJModel):
    def __init__(self, config):
        super().__init__(config)
        convert_to_int8(self)
        

class GPTJForCausalLM(gptj.modeling_gptj.GPTJForCausalLM):
    def __init__(self, config):
        super().__init__(config)
        convert_to_int8(self)
